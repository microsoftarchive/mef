...
namespace System.Composition.TypedParts
{
    ...
    {
        readonly IDictionary<CompositionContract, ICollection<DiscoveredExport>> _discoveredParts = new Dictionary<CompositionContract, ICollection<DiscoveredExport>>();
        ...
        void AddDiscoveredExport(DiscoveredExport export, CompositionContract contract = null)
        {
        ...
        void DiscoverConstrainedParts(CompositionContract contract)
        {
        ...
        // that close it.
        void DiscoverGenericParts(CompositionContract contract)
        {
