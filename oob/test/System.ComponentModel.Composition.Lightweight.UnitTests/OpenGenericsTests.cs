...
namespace System.ComponentModel.Composition.Lightweight.UnitTests
{
    ...
    public class OpenGenericsTests : ContainerTests
    {
        ...
        {
            IRepository<T> _repository = new BasicRepository<T>();
        ...
        {
            BasicRepository<T> _repository = new BasicRepository<T>();
        ...
        public void APartWithMultipleGenericExportsIsOnlyDiscoveredOnce()
        {
            ...
            Assert.AreEqual(2, others.Length);
        }
        ...
        {
            var x = AssertX.Throws<LightweightCompositionException>(() => CreateContainer(typeof(RepositoryWithKey<,>)));
        ...
        {
            var x = AssertX.Throws<LightweightCompositionException>(() => CreateContainer(typeof(RepositoryWithNonGenericExport<>)));
