...
namespace OnYourWayHome.ServiceBus.Messaging
{
    ...
    internal sealed class ReceiveAndDeleteMessageAsyncResult : ServiceBusRequestAsyncResult<BrokeredMessage>
    {
        private readonly string path;
        private readonly Uri uri;
        private readonly TimeSpan timeout;

        public ReceiveAndDeleteMessageAsyncResult(string path, TimeSpan timeout, TokenProvider tokenProvider)
            : base(tokenProvider)
        {
            this.path = path;
