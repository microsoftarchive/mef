...
namespace Microsoft.Composition.Demos.ExtendedCollectionImports.Dictionaries
{
    public class DictionaryExportDescriptorProvider : ExportDescriptorProvider
    {
        ...
        static readonly MethodInfo GetDictionaryDefinitionsMethod = typeof(DictionaryExportDescriptorProvider).GetTypeInfo().GetDeclaredMethod("GetDictionaryDefinition");
