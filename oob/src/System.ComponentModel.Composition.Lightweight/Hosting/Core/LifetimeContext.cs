...
namespace System.ComponentModel.Composition.Lightweight.Hosting.Core
{
    ...
    /// </remarks>
    /// <seealso cref="ExportLifetimeContext{T}"/>
    public sealed class LifetimeContext : ExportProviderBase, IDisposable
    {
        ...
        public override bool TryGetExport(Contract contract, out object export)
        {
