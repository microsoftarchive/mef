...
namespace System.ComponentModel.Composition.Lightweight.UnitTests
{
    ...
    public class SolA
    {
        IEnumerable<ExportFactory<IProj>> _fact;
    ...
    [Export(typeof(IX)), Export(typeof(IY)), PartCreationPolicy(CreationPolicy.Shared)]
    ...
    public class SharingTest : ContainerTests
    {
        ...
        public void ClassWithNonSharedExportFactoryCreatesSharedInstances()
        {
            ...
            // NB - inverting this assertion, I believe we can make a case for this behavior.
            Assert.AreSame(inst1, inst2);
        }

        ///TO DO ADD THE BOUNDARY CREATING TESTS HERE 
    }
}
