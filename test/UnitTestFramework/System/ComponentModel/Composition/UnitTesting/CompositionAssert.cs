...
namespace System.ComponentModel.Composition.UnitTesting
{
    public static class CompositionAssert
    {
        ...
        private static void AssertCore(int retryCount, string prefix, CompositionException error, CompositionErrorExpectation expectation)
        {
            if (expectation.IdSpecified)
            {
                Assert.Fail("Invalid expectation");
            }
