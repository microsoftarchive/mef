...
namespace DesktopStyleLifetimeDemo.Parts
{
    ...
    {
        readonly ExportFactory<Project> _projectFactory;
        readonly IDictionary<string, ExportLifetimeContext<Project>> _projects = new Dictionary<string, ExportLifetimeContext<Project>>();
