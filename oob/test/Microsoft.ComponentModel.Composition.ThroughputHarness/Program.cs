    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var suites = new[] {
                ...
                new Suite("Shootout with New (Fast)", 20000000, new Benchmark[] {
                    new LightweightNewBenchmark(),
                    new LightweightNLNewBenchmark(),
                    new OperatorNewBenchmark()
                }),
                new Suite("Shootout with New (Slow)", 200000, new Benchmark[] {
                    new MefNLNewBenchmark(),
                    new MefNewBenchmark()
                }),
                new Suite("Huge Graph (Fast)", 200000, new Benchmark[] {
                ...
                new Suite("Web (Fast)", 200000, new Benchmark[] {
                    new NativeCodeWebBenchmark(),
                    new LightweightWebBenchmark()
                }),
                new Suite("Web (Slow)", 20000, new Benchmark[] {
                    new MefWebBenchmark(operationIsThreadSafe: false),
                    new MefWebBenchmark(operationIsThreadSafe: true),
                }),
            };
