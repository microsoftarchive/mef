...
namespace System.Composition
{
    ...
    {
        static readonly DirectAttributeContext directAttributeContext = new DirectAttributeContext();
        ...
        {
            SatisfyImportsInternal(compositionContext, objectWithLooseImports, directAttributeContext);
        }
