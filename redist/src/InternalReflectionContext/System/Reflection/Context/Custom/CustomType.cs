...
namespace System.Reflection.Context.Custom
{
    internal class CustomType : ProjectingType
    {
        ...
        public override PropertyInfo[] GetProperties(BindingFlags bindingAttr)
        {
            ...
            results.AddRange(this.NewProperties);
        ...
        public override MethodInfo[] GetMethods(BindingFlags bindingAttr)
        {
            ...
            foreach (PropertyInfo prop in this.NewProperties)
            {
        ...
        protected override MethodInfo GetMethodImpl(string name, BindingFlags bindingAttr, Binder binder, CallingConventions callConvention, Type[] types, ParameterModifier[] modifiers)
        {
            ...
            // in runtime reflection hidden methods are always returned in GetMethods
            foreach (PropertyInfo newDeclaredProperty in this.NewProperties)
            {
            ...
            if (!getDeclaredOnly)
            {
                CustomType baseType = this.BaseType as CustomType;
